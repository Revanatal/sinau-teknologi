    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a target="_blank" href="<?= base_url(); ?>" class="nav-link">
                        <i class="fa fa-fw fa-eye"></i> Home
                    </a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary sidebar-no-expand">
            ...
            <a href="<?= base_url('dashboard') ?>" class="brand-link navbar-dark">
                <img src="<?= base_url(); ?>assets/dist/img/asu.jpeg" alt="Logo" class="brand-image img-circle">
                <span class="brand-text text-white">SINAU TEKNOLOGI</span>
            </a>
