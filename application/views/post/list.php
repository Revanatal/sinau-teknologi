...
<div class="page-header d-print-none">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h4 class="">
                <?= $selected_category ? "Category: " . get_category($selected_category) : "All Post"; ?>
            </h4>
        </div>
    </div>
</div>
...
<div class="row row-cards">
    ...
    ?>
        ...
        <div class="col-6 col-lg-4">
            <div class="card card-sm h-100" style="width: 16rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= base_url('post/view/') . $post->post_slug; ?>" class="text-decoration-none text-dark">
                        <h3 class="card-title font-weight-bold mb-0" style="font-size: 1.2em;"><?= $post->post_title; ?></h3>
                    </a>
                </div>
                <div class="card-footer bg-white">
                    <div class="d-flex align-items-center">
                        ...
                        <?php endif; ?>
                        <div>
                            <h4 style="display: inline;"><?= $post->fullname; ?></h4><br>
